...
error_folder_big=error/${decoder_flag}_run41
...
#	./perfect_measurement.out file=$file_name error_folder=$error_folder t=$t errorFilenamePrefix=$errorFilenamePrefix prob_begin=0.004 prob_end=0.0000009 prob_step=2 >>stdout_generate_error.log &
